...
| [task/plan](task/plan.workflow.mjs): paste the complete accepted draft as input, rather than only its filename.                                                                              | `/workflows run task/plan -- <complete accepted draft>`                                                          | Produces a checked workspace `workflow.mjs`, or keeps diagnostic evidence without publishing source when a gate fails. Demonstrates one author call with a bounded review-and-revise loop, [agent choices](../../docs/workflows/dsl.md#agent-options), and [primary file publication](../../docs/workflows/dsl.md#publishprimaryfile). See the [task guide](task/README.md) for the two-stage handoff.                   |
| [task/plan-light](task/plan-light.workflow.mjs): the same accepted draft, for a lighter author model.                                                                                        | `/workflows run task/plan-light -- <complete accepted draft>`                                                    | Produces the same checked `workflow.mjs` through designed, individually checked source slices; slower, with a gate after every step. See the [task guide](task/README.md).                                                                                                                                                                                                                                               |
